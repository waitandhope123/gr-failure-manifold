...
This document lists the execution and inspection commands for all diagnostic
toys in the GR Failure Manifold project.

Each toy is intended to be run individually. Many include example parameter
choices that intentionally push the system toward breakdown regimes.
...
Optional heuristic light-time estimate:
...
### Toy 024 — Horizon crossing times
...
### Toy 025 — Redshift vs acceleration
    ...
    python toy_025_redshift_vs_acceleration.py --r_emit 10,6,4,3,2.5,2.1,2.01

---

### Toy 026 — Extended-body EP breakdown
...
### Toy 042 — Numerical stability
    python toy_042_numerical_stability_limits.py

---

### Toy 043 — Foliation time
    python toy_043_foliation_time.py

---

### Toy 044 — Finite-size observer
...
### Toy 051 — ADM underdetermination
    chmod +x toy_051_adm_initial_data_underdetermination.py
    ./toy_051_adm_initial_data_underdetermination.py

---

### Toy 052 — Gauge vs physical modes
    chmod +x toy_052_gauge_mode_growth_vs_physical_modes.py
    ./toy_052_gauge_mode_growth_vs_physical_modes.py

---

### Toy 053 — Anisotropic stress TOV
    chmod +x toy_053_anisotropic_stress_tov.py
    ./toy_053_anisotropic_stress_tov.py

---

### Toy 054 — Imperfect fluid entropy
    chmod +x toy_054_imperfect_fluid_entropy.py
    ./toy_054_imperfect_fluid_entropy.py

---

### Toy 055 — Boxed scalar field
    chmod +x toy_055_boxed_boundaries_scalar_schwarzschild.py
    ./toy_055_boxed_boundaries_scalar_schwarzschild.py

---

### Toy 056 — Relational radar distance
    chmod +x toy_056_relational_radar_distance.py
    ./toy_056_relational_radar_distance.py

---

### Toy 057 — GW memory
    chmod +x toy_057_gw_memory_extended_detector.py
    ./toy_057_gw_memory_extended_detector.py

---

### Toy 058 — Thin shell junctions
    chmod +x toy_058_thin_shell_israel_junction.py
    ./toy_058_thin_shell_israel_junction.py

---

### Toy 059 — Shell crossing
    chmod +x toy_059_shell_crossing_multistream.py
    ./toy_059_shell_crossing_multistream.py

---

### Toy 060 — Scalar vs GR comparator
    chmod +x toy_060_scalar_vs_gr_comparator.py
    ./toy_060_scalar_vs_gr_comparator.py
